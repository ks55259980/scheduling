...
.gridHoverStyle {
  ...
  background-image: -webkit-gradient(linear, left bottom, left top, from(#ffe09d), to(#ffeabb));
...
.gantt_popup_button {
  ...
  background-image: -webkit-gradient(linear, left bottom, left top, from(#E6E6E6), to(#FFFFFF));
...
.gantt_task_progress {
  ...
  background-image: -webkit-gradient(linear, left bottom, left top, from(#abcee8), color-stop(36%, #5aa0d3), to(#bfdaee));
...
.gantt_task_link:hover .gantt_line_wrapper div {
  -webkit-box-shadow: 0 0 5px 0px #4a8f43;
